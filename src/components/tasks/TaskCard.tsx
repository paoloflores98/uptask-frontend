  ...
  return (
    <li className="p-5 bg-white border border-slate-300 flex justify-between gap-3">
      <div
        ...
        ref={setNodeRef} // Elemento que se requiere
        style={style} // Estilos con transform
      >
            ...
            <MenuItems
              ...
              <MenuItem>
                <button
                  ...
                  type='button'
                  onClick={() => navigate(location.pathname + `?viewTask=${task._id}`)} // location: API de JS
                >Ver</button>
              </MenuItem>
              {canEdit &&
                <>
                  <MenuItem>
                    <button
                      className='block px-3 py-1 text-sm leading-6 text-gray-900'
                      type='button'
                      onClick={() => navigate(location.pathname + `?editTask=${task._id}`)} // location: API de JS
                    >Editar</button>
                  </MenuItem>
