...
export default function DeleteProjectModal() {
  ...
  const checkUserPasswordMutation = useMutation({ // Mutación 1
    mutationFn: checkPassword,
    onError: (error) => toast.error(error.message)
  })

  const deleteProjectMutatiton = useMutation({ // Mutación 2
  ...
  const handleForm = async (formData: CheckPasswordForm) => {
    ...
    await deleteProjectMutatiton.mutateAsync(deleteProjectId);
  }
                ...
                >
                  <div className="flex flex-col gap-3">
                    ...
                    <input
                      ...
                      id="password"
                      type="password"
                      placeholder="Ingrese su contraseña de inicio de sesión"
                      {...register("password", {
